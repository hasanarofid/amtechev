<x-app-layout>
    ...
    <div class="max-w-2xl">
        <form action="{{ route('admin.testimonials.store') }}" method="POST" class="space-y-8" enctype="multipart/form-data">
            @csrf
            ...
            <div class="glass-card p-8 space-y-6">
                ...
                <div>
                    ...
                    <input type="hidden" name="content" id="quill-hidden-input" value="{{ old('content') }}">
                ...
                <div>
                    <label class="block text-[10px] font-bold uppercase tracking-widest text-text-muted mb-3">Upload Author Image</label>
