<x-app-layout>
    <x-slot:title>Add New Service</x-slot:title>
    <x-slot name="header">
        Create Service
    </x-slot>
        ...
        <form action="{{ route('admin.services.store') }}" method="POST" class="space-y-8">
            ...
            <div class="glass-card p-8 space-y-6">
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" required class="premium-input" placeholder="e.g. EV Charger Installation">
                ...
                <div>
                    ...
                    <textarea name="description" rows="4" class="premium-input" placeholder="Detailed description of the service...">{{ old('description') }}</textarea>
                ...
                <div x-data="{ 
                    open: false, 
                    search: '', 
                    selected: '{{ old('icon', 'heroicon-o-bolt') }}', 
                    icons: [
