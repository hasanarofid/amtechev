<x-app-layout>
    <x-slot:title>Add New Installation Package</x-slot:title>
    <x-slot name="header">
        Create Installation Package
    </x-slot>

    <div class="max-w-4xl">
        <form action="{{ route('admin.installation-packages.store') }}" method="POST" class="space-y-8">
            @csrf
            ...
            <div class="glass-card p-8 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="category" required class="premium-input bg-[#0a0a0a]">
                            ...
                            <option value="Routing / Cabling">Routing / Cabling</option>
                            <option value="Civil / Ground Works">Civil / Ground Works</option>
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required class="premium-input" placeholder="e.g. 5m Cabling & Installation">
                ...
                <div>
                    ...
                    <textarea name="description" rows="2" class="premium-input" placeholder="Short description for admin reference...">{{ old('description') }}</textarea>
