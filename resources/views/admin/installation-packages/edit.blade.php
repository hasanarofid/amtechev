            ...
            <div class="glass-card p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" step="0.01" name="price" value="{{ old('price', $installationPackage->price) }}" required class="premium-input" placeholder="e.g. 1498">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="price_3phase" value="{{ old('price_3phase', $installationPackage->price_3phase) }}" class="premium-input" placeholder="e.g. 1598">
                    ...
                    <div>
                        ...
                        <input type="text" name="price_unit" value="{{ old('price_unit', $installationPackage->price_unit) }}" class="premium-input" placeholder="e.g. meter, unit">
                ...
                <div x-data="{ addons: {{ json_encode($installationPackage->addons ?? []) }} }">
