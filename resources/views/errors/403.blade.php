...
<head>
    ...
    <title>403 - Forbidden | {{ config('app.name', 'AMTECH EV Specialist') }}</title>
...
<body class="antialiased h-screen flex items-center justify-center p-6 hero-bg">
    ...
    <div class="max-w-lg w-full text-center">
        <div class="mb-10">
            <a href="/">
                <img src="{{ asset('logo/amtech-removebg.png') }}" alt="Logo" class="h-16 w-auto mx-auto mb-8 animate-pulse">
            </a>
            <h1 class="text-8xl font-black mb-4 tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-500">403</h1>
            <h2 class="text-3xl font-bold mb-4 tracking-tight">Access Denied</h2>
            <p class="text-gray-400 mb-10 text-lg">You don't have permission to access this area. If you believe this is an error, please contact support.</p>
