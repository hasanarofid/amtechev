            ...
            <div class="glass-card p-8 space-y-6">
                ...
                <div x-show="activeTab === 'en'" class="space-y-6 animate-fade-in">
                    ...
                    <div>
                        ...
                        <input type="hidden" name="content" id="quill-hidden-input-en" value="{{ old('content', $blogPost->content) }}">
                ...
                <div x-show="activeTab === 'ms'" x-cloak class="space-y-6 animate-fade-in">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="title_ms" value="{{ old('title_ms', $blogPost->title_ms) }}" class="premium-input">
                        ...
                        <div>
                            ...
                            <input type="text" disabled class="premium-input opacity-50" value="{{ $blogPost->category }}">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="excerpt_ms" class="premium-input min-h-[80px]">{{ old('excerpt_ms', $blogPost->excerpt_ms) }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="hidden" name="content_ms" id="quill-hidden-input-ms" value="{{ old('content_ms', $blogPost->content_ms) }}">
                ...
                <div class="pt-6 border-t border-glass-border space-y-6">
                    ...
                    <div>
                        <label class="block text-[10px] font-bold uppercase tracking-widest text-text-muted mb-3">Upload Featured Image (Leave blank to keep current)</label>
                        ...
                        @if($blogPost->image_url)
                            <div class="mt-4 p-2 bg-glass border border-glass-border rounded-xl inline-block">
                                <img src="{{ str_starts_with($blogPost->image_url, 'http') || str_starts_with($blogPost->image_url, '/') ? $blogPost->image_url : asset('storage/' . $blogPost->image_url) }}" class="h-20 w-auto rounded-lg object-cover">
                            </div>
                        @endif
