        ...
        <form action="{{ route('admin.blog-posts.update', $blogPost) }}" method="POST" class="space-y-8" enctype="multipart/form-data">
            ...
            <div class="glass-card p-8 space-y-6">
                ...
                <div>
                    ...
                    <div id="quill-editor" class="bg-glass text-main min-h-[300px] rounded-b-xl border border-glass-border"></div>
                    <input type="hidden" name="content" id="quill-hidden-input" value="{{ old('content', $blogPost->content) }}">
