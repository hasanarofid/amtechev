    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-14 relative z-10">
        <div class="flex flex-col lg:flex-row gap-20 items-center">
            ...
            <div class="lg:w-1/2 order-1 lg:order-2">
                ...
                <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $settings['whatsapp_number'] ?? '601167686742') }}?text={{ urlencode('Speak to an EV Charging Specialist — From a Free Site Visit and Consultation to Full Installation , We handle everything with expert workmanship and transparent pricing.') }}" 
                   target="_blank" 
                   class="flex flex-col md:flex-row items-center gap-6 p-8 rounded-[2.5rem] bg-ev-green text-black group/cta hover:scale-[1.02] active:scale-[0.98] transition-all duration-500 cursor-pointer shadow-lg hover:shadow-ev-green/20 relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        <p class="text-xl md:text-2xl font-black leading-snug">
                            "Speak to an EV Charging Specialist — From a Free Site Visit and Consultation to Full Installation , We handle everything with expert workmanship and transparent pricing."
                        </p>
