    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-14">
        ...
        <div class="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
            <div class="flex flex-col md:flex-row items-center gap-6">
                <!-- Registration Badge -->
                @if(isset($settings['registration_number']) && $settings['registration_number'])
                <div class="bg-[#FFD700] text-black px-4 py-1.5 rounded-full flex items-center gap-2 shadow-lg shadow-yellow-400/20">
                    ...
                    <span class="text-[10px] font-black uppercase tracking-widest">{{ $settings['registration_number'] }}</span>
                </div>
                @endif
