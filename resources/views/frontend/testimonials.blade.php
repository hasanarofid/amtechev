...
<section class="py-32 bg-black overflow-hidden border-t border-white/5">
    <div class="max-w-7xl mx-auto px-6 lg:px-14">
        <div class="text-center mb-20">
            ...
            <h2 class="text-3xl lg:text-5xl font-bold mb-4 italic">Amtech EV reviews from owners and experts</h2>
            <p class="text-gray-500 uppercase tracking-widest text-sm font-bold">EXPERIENCE THE Amtech Ev DIFFERENCE TODAY</p>
        </div>
